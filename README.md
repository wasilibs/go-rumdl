...
functionality of rumdl in Go, instead building it into a WebAssembly binary which is compiled to pure Go
using [wasm2go][2]. This means that `go install` or `go run`
